...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid29sZmJyYW5kIiwiYSI6ImNrNzF0MGpieDA2dHEzb3AxZWczc251OXIifQ.EmA5yeVWebw5vjkLrTDMBw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Add corrdinates to the map bounds
...
var stripe = Stripe('pk_test_YtF6aY9oBvEAK59SdvcV3FXV005rMWjH81');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return (0, _updateUserSettings.updateSettings)(form, 'data');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _updateUserSettings.updateSettings)({
                password: password,
            ...
            case 7:
              password = (_readOnlyError("password"), document.getElementById('password-current').value = '');
              passwordNew = (_readOnlyError("passwordNew"), document.getElementById('password').value = '');
